...
import de.uni_hamburg.pepper.cubhuni.json.CubhuniJSONImporter;
 ...
 * {@link CubhuniJSONImporter} class. Feel free to adapt and enhance this test class
 ...
 */
public class CubhuniJSONImporterTest extends PepperImporterTest {
	/**
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("CubhuniJSONImporter"));
